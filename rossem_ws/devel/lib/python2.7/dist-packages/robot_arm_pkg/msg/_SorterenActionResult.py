...
"""autogenerated by genpy from robot_arm_pkg/SorterenActionResult.msg. Do not edit."""
import codecs
import sys
...
class SorterenActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "robot_arm_pkg/SorterenActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_arm_pkg/SorterenResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SorterenActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_arm_pkg.msg.SorterenResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_arm_pkg.msg.SorterenResult()
