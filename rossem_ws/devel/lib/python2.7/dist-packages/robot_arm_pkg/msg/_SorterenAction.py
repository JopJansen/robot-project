...
"""autogenerated by genpy from robot_arm_pkg/SorterenAction.msg. Do not edit."""
import codecs
import sys
...
import genpy
import robot_arm_pkg.msg
import std_msgs.msg

class SorterenAction(genpy.Message):
  _md5sum = "e1f689e26e80e53f8765064b80a41587"
  _type = "robot_arm_pkg/SorterenAction"
...
"""
  ...
  _slot_types = ['robot_arm_pkg/SorterenActionGoal','robot_arm_pkg/SorterenActionResult','robot_arm_pkg/SorterenActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SorterenAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = robot_arm_pkg.msg.SorterenActionGoal()
      if self.action_result is None:
        self.action_result = robot_arm_pkg.msg.SorterenActionResult()
      if self.action_feedback is None:
        self.action_feedback = robot_arm_pkg.msg.SorterenActionFeedback()
    else:
      self.action_goal = robot_arm_pkg.msg.SorterenActionGoal()
      self.action_result = robot_arm_pkg.msg.SorterenActionResult()
      self.action_feedback = robot_arm_pkg.msg.SorterenActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.tf_frame
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.doel_positie
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.tf_frame = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.tf_frame = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.doel_positie = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.doel_positie = str[start:end]
      _x = self
      start = end
      end += 12
